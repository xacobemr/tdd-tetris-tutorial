...
public class Step6RotatingAFallingPieceTest extends Assert {
  ...
  // TODO: it cannot be rotated when there is no room to rotate (left wall,
  // right wall, other pieces...)

  // TODO: when piece is up against a wall (or piece) and it is rotated (no room
  // to rotate), move it away from the wall ("wallkick")
